...
namespace pd_pid_controller_ns 
{
	class PdPidController : public controller_interface::Controller<hardware_interface::EffortJointInterface>
	{
		bool init(hardware_interface::EffortJointInterface* hw, ros::NodeHandle &n){
			...
			sub_command_ = n.subscribe<std_msgs::Float64>("command", 1, &PdPidController::setCommandCB, this);
	...
	PLUGINLIB_EXPORT_CLASS(pd_pid_controller_ns::PdPidController, controller_interface::ControllerBase);
