...
namespace pdg_controller_ns 
{
	class PdgController : public controller_interface::Controller<hardware_interface::EffortJointInterface>
	{
		bool init(hardware_interface::EffortJointInterface* hw, ros::NodeHandle &n){
			...
			sub_command_ = n.subscribe<std_msgs::Float64>("command", 1, &PdgController::setCommandCB, this);
	...
	PLUGINLIB_EXPORT_CLASS(pdg_controller_ns::PdgController, controller_interface::ControllerBase);
