...
namespace p_controller_ns 
{
	class PController : public controller_interface::Controller<hardware_interface::EffortJointInterface>
	{
		bool init(hardware_interface::EffortJointInterface* hw, ros::NodeHandle &n){
			...
			sub_command_ = n.subscribe<std_msgs::Float64>("command", 1, &PController::setCommanCB, this);
		...
		void update(const ros::Time& time, const ros::Duration& period){
            ...
            double error_dot = -joint_.getVelocity();
		...
		void setCommanCB(const std_msgs::Float64ConstPtr& msg){
	...
	PLUGINLIB_EXPORT_CLASS(p_controller_ns::PController, controller_interface::ControllerBase);
